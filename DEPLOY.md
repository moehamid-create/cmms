...
The app refuses to start in production without a strong `SESSION_SECRET`. The old demo password `1234` is rejected in production. Use the built-in Users screen to set real passwords after first-run setup.
